...
class leaveStudent extends StatefulWidget {
  @override
  _ToDoListAppState createState() => _ToDoListAppState();
}

class _ToDoListAppState extends State<leaveStudent> {
      ...
      body: Column(
        children: <Widget>[
          Padding(
            ...
            child: Text(
              'leaved Student: $completedTasksCount',
              style: TextStyle(
